...
<body class="bg-gradient-primary">
					...
					<div class="col-lg-7">
						<div class="p-5">
                            ...
                            <?php if (validation_errors()):?>
								...
								<a href="login.php" class="btn btn-primary btn-user btn-large">
									Register Account
								</a>
								<hr>
	...
	<script src="<?php echo base_url() ?>assets/vendor/vendor-admin/vendor/jquery/jquery.min.js"></script>
	<script src="<?php echo base_url() ?>assets/vendor/vendor-admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Core plugin JavaScript-->
	<script src="<?php echo base_url() ?>assets/vendor/vendor-admin/vendor/jquery-easing/jquery.easing.min.js"></script>
