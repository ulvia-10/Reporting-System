...
<head>
  ...
  <link href="<?php echo base_url('assets/vendor/vendor-admin/datatables/dataTables.bootstrap4.min.css') ?>" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="<?php echo base_url('assets/vendor/vendor-admin/js/demo/datatables-demo.js') ?>"></script>
