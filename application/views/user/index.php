      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p>
            Badan Kesatuan Bangsa dan Politik Kota Malang merupakan Perangkat Daerah Yang Melaksanakan Urusan Pemerintah di Bidang Kesatuan Bangsa Dan Politik Pemerintahan Di Bidang Kesatuan Bangsa Dan Politik  Berkedudukan di Bawah Wali Kota Malang
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Melaksanakan Penyiapan Bahan dalam rangka penyusunan petunjuk teknis</li>
              <li><i class="ri-check-double-line"></i> Pelaksanaan evaluasi dan pelaporan tugas dan fungsi  penanganan konflik</li>
              <li><i class="ri-check-double-line"></i> Pelaksanaan fasilitas penanganan konflik sosial</li>
            </ul>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100" style="margin-left:100px">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200" style="margin-left:200px">
            <div class="info">
              <div>
                <i class="ri-map-pin-line"></i>
                <p>Jl. A. Yani No.98, Purwodadi<br>Kec. Blimbing, Kota Malang,Jawa Timur 65125</p>
              </div>
    ...
    <div class="container">
      <div class="row d-flex align-items-center">
        <div class="col-lg-6 text-lg-left text-center">
          <div class="copyright">
            &copy; 2021 Copyright <strong>  Bakesbangpol</strong>. <br> All Rights Reserved
          </div>
