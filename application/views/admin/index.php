...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="assets/vendor/vendor-admin/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="assets/vendor/vendor-admin/js/demo/chart-area-demo.js"></script>
    <script src="assets/vendor/vendor-admin/js/demo/chart-pie-demo.js"></script>
